...
<title>클래식기타 커뮤니티</title>
  ...
  <link rel="stylesheet" type="text/css" href="${pagaContext.request.contextPath }/resources/css/board_list_main.css">
</head>
<body>
<div id="wrap">
<header>
  ...
  <section id="main">
    ...
    <div id="total_search">
      ...
      <form action="board_list">
	      <div id="search">
	        <div id="select_img"><img src="${pagaContext.request.contextPath }/resources/img/select_search.gif"></div>
	        ...
	        <div id="search_btn"><input type="image" src="${pagaContext.request.contextPath }/resources/img/search_button.gif"></div>
	      </div>
      </form>
    ...
    <table>
      ...
      <tr>
        ...
        <td class="col4">
        	<c:out value="${fn:substring(fbdto.fbdate, 0, 10) }"></c:out> <!-- 날짜만 출력 0번째부터 10번째까지만 -->
        </td>
